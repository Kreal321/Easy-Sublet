...
public class AddRoommatePostViewModel extends AndroidViewModel {

    private static final String TAG = "AddRoommatePostViewModel";
    private final MutableLiveData<RoommatePost> post;
    private MutableLiveData<Uri> uriMutableLiveData;
    private MutableLiveData<User> userMutableLiveData;
    private postRepo repo;
    private mainRepo accountRepo;

    public AddRoommatePostViewModel(Application application) {
        super(application);
        ...
        Log.d(TAG, "AddRoommatePostViewModel() is called");
    }
